...
module.exports.ErrorMapper = restErrors.ErrorMapper;
module.exports.ErrorHandler = restErrors.ErrorHandler;
...
module.exports.Initialize = initialize = function(app, mongoose) {
    ...
    fs.readdir(modelsPath, function(err, files){
        ...
        files.forEach(function(file){
            ...
            path.exists(controllerPath + '.js', function(exists){
                controllers[name] = controller = exists ? require(controllerPath)[name + 'Controller'](controller, app) : controller;
...
module.exports.BaseController = baseController = BaseObject.extend({
    model : null,
    name : '',
    plural : '',
...
module.exports.RegisterRoutes = registerRoutes = function(app, controller) {
